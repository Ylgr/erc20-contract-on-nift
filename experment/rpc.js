...
const storeAddress = require('../build/contracts/Store.json').networks["2160"].address;
const tokenAddress = require('../build/contracts/Token.json').networks["2160"].address;
